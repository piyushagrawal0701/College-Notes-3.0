    ...
    <>
      <section className="text-gray-600 body-font ">
        <div className="container px-5 pt-32 mx-auto contact-section">
          <h1 className="text-3xl font-semibold title-font text-[#227db7] pb-1 text-center">
            Contact us
          </h1>
          <div className="sm:text-base text-sm leading-relaxed w-1/6 border-t-4 sm:mb-20 mb-10 border-[#227db7] rounded-md  mx-auto"></div>
              ...
              <div className="w-full h-full bg-gray-100 sm:p-8 p-6 rounded">
                ...
                <div className="flex flex-col ">
                  <a className="inline-flex items-center justify-center">
                    <p className="w-12 h-12 text-2xl rounded-full flex-shrink-0 object-cover object-center text-[#227db7]">
